...
var crudexampleApp = angular.module('crudexampleApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'crudexampleAppUtils', 'pascalprecht.translate', 'truncate']);
